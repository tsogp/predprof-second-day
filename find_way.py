...
def f(point, current_way, current_value, been):
    global q
    # print(current_way)
    if point == finish:
    ...
    if point[1] - 1 > 0 and not been[point[1] - 1][point[0]] and 0 < matrix[point[1] - 1][point[0]] < 2:
        ...
        f(new_point, current_way + [new_point], current_value + matrix[new_point[1]][new_point[0]], been)
...
f(start, [start], matrix[start[1]][start[0]], been)
# print(q)
